...
-   [Requests for screen layout](/wiki/Requests_for_screen_layout "wikilink")
-   [Requests for keys, buttons,
    menus](/wiki/Requests_for_keys,_buttons,_menus "wikilink")
-   [Requests for Resource collection
    mechanics](/wiki/Requests_for_Resource_collection_mechanics "wikilink")
-   [Requests for Immigration
    mechanics](/wiki/Requests_for_Immigration_mechanics "wikilink")
-   [Requests for World map
    mechanics](/wiki/Requests_for_World_map_mechanics "wikilink")
...
- Each creature has its own “room” (where a room is a continuous space
...
-   Nothing major? Heh, heh. --[Red
    kangaroo](/wiki/User%3ARed_kangaroo "wikilink")
