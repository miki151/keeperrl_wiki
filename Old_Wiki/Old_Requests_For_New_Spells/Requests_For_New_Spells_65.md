---
title: Requests For New Spells 65
permalink: Requests_For_New_Spells_65/
layout: wiki
---
References:
...
* Cooldown: 200
* Concept: Bandits can steal items such as gold from your character, make it annoying so you have to kill the bandit that stole it to retrieve the item. Not only that, but they can steal potions that could be used against you.
