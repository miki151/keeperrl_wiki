---
title: Requests For New Spells 69
permalink: Requests_For_New_Spells_69/
layout: wiki
---
References:
...
* Cooldown: 100
* Concept: Pull an item close to an enemy towards you, or just an item that is relatively far so you don't have to walk much. Can also be used to pull creatures trying to run away from you.
* Purpose in the game: Can be useful when you want to kill something or someone trying to run away from you, so you can use this to bring them closer to you, or pull an item that would be across a river or lake, in an un-reachable location, towards the caster.
