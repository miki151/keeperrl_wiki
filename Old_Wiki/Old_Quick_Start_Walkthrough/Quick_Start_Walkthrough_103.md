---
title: Quick Start Walkthrough 103
permalink: Quick_Start_Walkthrough_103/
layout: wiki
---
...
before.
*Last checked for accuracy and being up-to-date on Alpha 23.
...
You start with your [[keeper]] and 4 minion [[imp]]s. You will occasionally see text in orange. These hints will provide you with ideas on what to do next. When playing the tutorial, there are step-by-step instructions at the bottom of the screen. Campaigns have a master map, which contain other smaller maps. The main villains and allies will be found on this master map. View this using the compass icon.
...
Press 't' to travel to other map sectors on the campaign map. Note that it is possible to select a whole team of minions, control them and invade. Press 'g' to manage every move of each team member.
...
You will have to travel to other map sectors to find the bases belonging to most of the bigger tribes and to do that, you will need to control a team or minion.
