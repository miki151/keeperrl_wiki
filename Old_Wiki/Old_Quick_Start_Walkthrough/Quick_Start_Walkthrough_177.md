---
title: Quick Start Walkthrough 177
permalink: Quick_Start_Walkthrough_177/
layout: wiki
---
...
before.
*Last checked for accuracy and being up-to-date on Alpha 26. February 3rd 2019.
...
[[File:Tabs-Screenshot.png|1000px|link=]]
 Tabs-Screenshot.png

Below the mini map in the top right are two buttons
* Campaign Map (compass icon)
* Find keeper (keeper icon)
* You can also click on the mini map to see it full size.

[[File:MiniMap-Screenshot.png|1000px|link=]]
 MiniMap-Screenshot.png
...
The next thing you probably want to build is a library. The library is important because the shaman, vampires and other spell casters need to research spells there.
...
Then simply build your library in that space from the orders menu. The bookshelves will get in your way, so place them one-by-one at suitable locations. The [[keeper]] will usually immediately move to the library and spend most of the time there. Dot some torches around the library walls and consider laying down some crude flooring. Watch out for using too many wooden floors, because later on in the game, they may get set alight.

Now that the library is built your minions can start researching spells.

Next build a few wooden training dummies in a different room and after that a few workshop stands. Have a room for beds and a room for cages. Recruit a small team of minions and let them train, study and craft some wooden items.
