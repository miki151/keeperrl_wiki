---
title: Quick Start Walkthrough 11
permalink: Quick_Start_Walkthrough_11/
layout: wiki
---
...
1) Construction (pickaxe icon)
2) Minions (horned face icon)
3) Research (book icon)
4) Tribes (weapons icon)
5) Help (question mark icon)== Resource stats ==
...
You need to build other rooms to attract monsters into your dungeon. Some minions will set up home with you if you give them a dormitory to rest. Other monsters would like places to train, or build things. Some monsters will expect to be paid in exchange for their work. Build a graveyard to keep corpses and you may be able to raise the dead. Other types of undead will come to practice rituals in a ritual room.
