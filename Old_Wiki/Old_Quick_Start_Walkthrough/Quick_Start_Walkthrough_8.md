---
title: Quick Start Walkthrough 8
permalink: Quick_Start_Walkthrough_8/
layout: wiki
---
...
Here you can find videos that explain the basics of the game.
...
The next thing you want to build is a library.  The library is crucial because the keeper needs it to research any new skills.
...
Now that the library is built you can start researching skills.  Under the &quot;Creatures&quot; menu, there is an item called &quot;Library&quot;.  Clicking
...
The first skill I usually learn right away is crafting, because that is the skill needed to build anything else, like beds (which you will
...
You need to build other rooms to attract monsters into your dungeon. Some minions will set up home with you if you give them a place to rest. Other monsters would like places to train, or build things. Some monsters will expect to be paid in exchange for their work. Build a graveyard to keep corpses and you may be able to raise the dead. Other types of undead will come to practice rituals in a ritual room.

== Treasure Room ==

When you have dug out some gold, you can store it in a treasure room. Once the gold is collected, you can use it to pay your minions. If you run out of gold, your minions will get demotivated. In the worst case, they will simply lie around in bed all day until you have money to pay them.


== Invaders ==

Rumors about your dungeon will spread as it grows. These will attract recruits but can also attract invaders. Invaders may be out to plunder your gold, gain combat experience or just to assassinate your keeper. Invaders may carry useful items to loot.


== More to come ==

* Gnomes, goblins, ogres
* Black market
* Crafting
* Alchemy
* Prisoners
