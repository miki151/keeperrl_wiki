---
title: Alternative Keeper Characters 142
permalink: Alternative_Keeper_Characters_142/
layout: wiki
---
...
*Fire Resistance for Minions - All minions gain fire resistance.
*Stun Semi resistance - Stun time/entangle time for minions is halved.
*Limb-regrowth- minion regrow limbs when healed by an orc shaman, then go to rest (if not in battle) to recover for a day (1000 turns)
