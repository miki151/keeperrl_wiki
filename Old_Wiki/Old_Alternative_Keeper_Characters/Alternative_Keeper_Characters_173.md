---
title: Alternative Keeper Characters 173
permalink: Alternative_Keeper_Characters_173/
layout: wiki
---
...
=Demonic Wizard=
Long ago in a distant land, I unleashed an unspeakable evil upon the land. But a mighty warrior came to oppose me, and flung me into this world. Now I will conquer this world to take my revenge.'
*Based on Aku from Samurai Jack.
This character specializes in mana production. 

==Immigration==
This character does not have access to normal minion immigration, instead, this unit uses mana to summon units. Minions that spawn from rituals are the exception and are recruited normally.

==Buffs==
*Enhanced mana production. Gains 1 mana every 2 turns passively.
*Access to mana spawned minions.
*Access to unique &quot;keeper&quot; enhancement skill tree
*Initial population limit is raised by 2.
*Has darkness skill

==Pitfalls==
*After the first 5000 or so turns, a legendary warrior spawns on the base map and attacks you.
* Legendary warriors continue to spawn once every day at a random time.
*After 5 days, legendary warriors come in pairs.
&quot;A warrior was sent by your archenemies&quot; 
...
*All requirements must be met before minions can spawn. Undead need corpses.
...
==Research==
*Base skill tree as Keeper with few demonic additions
...
*Shapeshifting spells are only for the keeper avatar. 

===Shapeshifting 1===

*Become Immense: character becomes visually larger and stronger (60 turns)
*Dog: Turn into a black dog with a blue face. (60 turns) Unarmed attack bonus + 10, and extra speed
