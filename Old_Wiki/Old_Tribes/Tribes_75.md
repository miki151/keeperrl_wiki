...
This is a grid showing friendships between tribes marked with an X. Note that &quot;hostile&quot; is the only tribe hostile to itself. Hostile monsters of the same tribe will fight each other.
...
If you are going to mod the tribes data, you may need to work out the tribal loyalty for a new tribe you made. Use the grid above to select a tribal loyalty.
