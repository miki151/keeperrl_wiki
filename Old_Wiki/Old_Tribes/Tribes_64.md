...
|- align=&quot;right&quot;
|'''1.Monster'''    ||X||.||X||.||X||X||.||X||X||X||.||X||X||X||.||.||X||.
|- align=&quot;right&quot;
|'''2.Lizard'''     ||.||X||X||X||X||X||.||X||X||X||.||X||X||X||X||.||X||.
|- align=&quot;right&quot;
|'''3.Pest'''       ||X||X||X||X||X||X||X||X||X||X||.||X||X||X||X||.||X||.
|- align=&quot;right&quot;
...
|- align=&quot;right&quot;
|'''10.Lawful'''    ||X||X||X||X||X||X||X||X||X||X||.||X||X||X||X||.||X||.
|- align=&quot;right&quot;
|'''11.Evil'''      ||.||.||.||X||.||X||.||.||X||.||X||.||X||.||X||.||X||.
|- align=&quot;right&quot;
|'''12.Retired'''   ||X||X||X||X||X||X||X||X||X||X||.||X||X||X||X||.||X||.
|- align=&quot;right&quot;
|'''13.Greenskin''' ||X||X||X||X||X||X||X||X||X||X||X||X||X||X||X||.||X||.
|- align=&quot;right&quot;
|'''14.Ant'''       ||X||X||X||X||X||X||.||X||X||X||.||X||X||X||X||.||X||.
|- align=&quot;right&quot;
...
|}
  ...
  addEnemies(ret, TribeId::getDarkKeeper(), {
      TribeId::getElf(), TribeId::getDwarf(), TribeId::getHuman(), TribeId::getLizard(),
