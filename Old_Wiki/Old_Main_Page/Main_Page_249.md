...
''Features include modding support, Steam Workshop integration, z-levels, fighting other players retired dungeons, convertible prisoners, outside buildings, 3 keeper classes both good and evil, an adventurer class where you don't bother building a dungeon, between about 120 and 150 types of creatures and open source code.

''A very open-minded indie developer. He will probably even help you compile his game from his own publicly available code. You can get the game for free in ASCII mode without sound. You can also buy the full game by donating to various wildlife charities. If you don't want graphics and sound and see no reason to support someone you don't know, there is a free version just for you.

''The game does change a lot every release, so it is fun to keep coming back to it and see how it is developing. Some will feel sad when the game is &quot;finished&quot; and would be happy to see it evolve forever. Obviously the game is Early Access, so if you want to contribute to a game as it keeps evolving and like Rogue-likes and RTS games, you should love this.
