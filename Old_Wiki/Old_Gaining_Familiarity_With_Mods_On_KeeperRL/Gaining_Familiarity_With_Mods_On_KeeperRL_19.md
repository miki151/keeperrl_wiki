---
title: Gaining Familiarity With Mods On KeeperRL 19
permalink: Gaining_Familiarity_With_Mods_On_KeeperRL_19/
layout: wiki
---
==Recommended method==
...
*Test them
*Make some simple changes to the vanilla files (Try some of the suggestions below) and test the changes.
