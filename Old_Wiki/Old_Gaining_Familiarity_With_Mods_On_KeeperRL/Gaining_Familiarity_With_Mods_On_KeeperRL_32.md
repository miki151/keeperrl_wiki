---
title: Gaining Familiarity With Mods On KeeperRL 32
permalink: Gaining_Familiarity_With_Mods_On_KeeperRL_32/
layout: wiki
---
...
**Local mods (Edit the [[Offical_Game_Configs | official game files]] locally) - Can't be uploaded onto the Web. Easier to learn for beginners.
...
Locate workshops_menu.txt. It should look like [[Workshops_Menu.txt|this linked file, which is a bit out of date but basically similar]].
