---
title: Old Requests For New Minions
permalink: Old_Requests_For_New_Minions/
layout: wiki
---
...
== Mummy (Implemented in Alpha 26) ==
* Start level : 3
* Stats: weak at combat with slow training but can train very many levels
* Optional features: Suicide unit that blows itself up (Not implemented in Alpha 26) 
* Discussion:
