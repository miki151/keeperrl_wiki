---
title: Map Editor Ideas 38
permalink: Map_Editor_Ideas_38/
layout: wiki
---
...
*Tribe type (Main villain/Minor villain/allies) Drop down list - only set to &quot;allies&quot; if tribe id is a valid ally
*Tribe Icon (Select view ID from a list that will appear on campaign maps)
*Triggers: Dropdown - [Gold/Proximity/Throne/Stealing/Trespassing]
*Initial Biome: Dropdown - [Grassland, Forest, Mountain, 100% Sand, 100% grass, 100% water, 100% lava, 100% rock]
*Example - Create a new tribe called River Pirates, with a loyalty to bandits. Make them a minor villain, select the view id for bandits. Give them a trigger of gold. Put them in a forest biome.
*&quot;Generate Terrain&quot; Button. Click this to generate a map and move to the Terrain Editor.
