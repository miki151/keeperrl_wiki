...
If you are going to mod the tribes data, you may need to work out the alliance for a new tribe you made. Use the grid above to select an alliance. Note that &quot;hostile&quot; is the only tribe hostile to itself. Hostile monsters of the same tribe will fight each other!
