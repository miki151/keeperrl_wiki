...
To gather resources you have to select them the ''Dig or cut tree''-tool.&lt;br&gt;
Your [[:Imp|Imps]] will then start to harvest the resource and carry it to your [[:Storage|stockpiles]].
...
Wood is used to build [[:Category:Rooms|rooms]] and [[:Installations|installations]].
...
Iron is used to build [[:Category:Rooms|rooms]].
...
Granite is used to build [[:Category:Rooms|rooms]].
