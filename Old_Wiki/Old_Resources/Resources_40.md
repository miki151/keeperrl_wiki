...
===Prisoner Heads===
 These are used to hang up outside your dungeon to provoke the self righteous into getting squashed by your boulder traps :)

===Corpses===
 Corpses are used to raise undead when placed in a graveyard.

===Ranged weapons===
 You need to have ranged weapons in your equipment stockpile before you can recruit ranged units.
