...
Wood is used to build [[:Category:Rooms|rooms]] (around 2/3 of them) and [[:Installations|installations]], like [[:Installations#Door|doors]], [[:Installations#Bridge|bridges]], etc. It's the first resource you are gonna need as it takes some wood per [[:Library|library]] bookcase, enabling [[:Technologies|research]].
...
Mana is used to do [[:Technologies|research]] and build your [[:Throne|throne]] once you can.
