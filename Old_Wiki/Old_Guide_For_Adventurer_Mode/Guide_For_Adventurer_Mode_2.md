---
title: Guide For Adventurer Mode 2
permalink: Guide_For_Adventurer_Mode_2/
layout: wiki
---
...
If you have beaten a new map, that nobody else has beaten, then please update this page with a guide for that map.
...
There are some free mushrooms in a cave some way north. Ignore the bandits nearby and follow the mountain around to the southeast. Cross the river. Eat mushrooms for strength and dexterity bonus. Get prepared for a massive battle, eat strength and dexterity mushrooms. Use the healing potion(s) if you are wounded in combat but try and use first aid kits instead. If your enemies are being healed by an orc shaman, back out to a different location and then try again.
