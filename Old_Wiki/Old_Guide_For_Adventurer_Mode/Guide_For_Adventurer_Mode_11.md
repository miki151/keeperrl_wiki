---
title: Guide For Adventurer Mode 11
permalink: Guide_For_Adventurer_Mode_11/
layout: wiki
---
...
However, Bogust has set up the Boulder/Web trap combination (Boo! Hiss!).  If you step into the web you are trapped and hit by a boulder. It is not always possible to win. There is a very important teleport scroll if you get webbed next to a certain large rock. 

Head northwest, cross the river west, cross over the river again north. Enter the mountain door and step aside from the first boulder. To beat Bogust, you will have probably have to read the teleport scroll and teleport randomly, to get past the boulders. 

If you do find the keeper, use speed, throw sleep at him and shoot him. He is a weak keeper.
