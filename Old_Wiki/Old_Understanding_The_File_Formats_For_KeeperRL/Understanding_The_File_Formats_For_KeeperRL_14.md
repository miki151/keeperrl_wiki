---
title: Understanding The File Formats For KeeperRL 14
permalink: Understanding_The_File_Formats_For_KeeperRL_14/
layout: wiki
---
...
*The entry has two possible formats
1) {{[[ItemTypeID]]} '''Speed''' [[ResourceID]] '''Amount'''}
Example:
 {{LeatherGloves} 1 WOOD 2}
*The entry has two possible formats
2) {{[[ItemTypeID]]} '''Speed''' [[ResourceID]] '''Amount''' &quot;'''TechID''']]}
Example:
