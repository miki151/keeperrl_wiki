---
title: Understanding The File Formats For KeeperRL 15
permalink: Understanding_The_File_Formats_For_KeeperRL_15/
layout: wiki
---
=general rules=
...
*The entry has two possible formats
1) {{[[ItemType|ItemTypes]]} '''Speed''' [[ResourceID|ResourceIDs]] '''Amount'''}
Example:
 {{LeatherGloves} 1 WOOD 2}
*The entry has two possible formats
2) {{[[ItemType|ItemTypes]]} '''Speed''' [[ResourceID|ResourceIDs]] '''Amount''' &quot;'''TechID''']]}
Example:
