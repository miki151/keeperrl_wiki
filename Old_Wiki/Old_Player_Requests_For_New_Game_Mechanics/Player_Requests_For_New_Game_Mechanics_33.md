---
title: Player Requests For New Game Mechanics 33
permalink: Player_Requests_For_New_Game_Mechanics_33/
layout: wiki
---
= Game Mechanics =
...
== Storyline ==
The player would like to know why the keeper exists and wants to destroy the world. To solve this issue, generic/funny splash pages that are triggered when a keeper or his minions enter an area, or when an enemy squad enters the keeper area, are desired.
...
* Banished from the town of X for his/her nefarious xing, 'Wizard name X' begins plotting his/her revenge. It will start with the locals and end with the WORLD! IF 'Wizard name X' survives that is... It all started with the summoning of a few minions... A dark kingdom rises.
