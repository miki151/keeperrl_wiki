---
title: Old Requests For New Weapons
permalink: Old_Requests_For_New_Weapons/
layout: wiki
---
= Melee weapons =
...
=== Insanity Mace (Weapons producing insanity are possible in Alpha 27)===
*Damage: 12
*Accuracy = 5
*Attack type: Blunt
*Weight: 10
...
== Wooden shield (There's wooden shields in Alpha 27) ==
*Damage reduction but not the same as armour.
