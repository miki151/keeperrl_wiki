...
*A: Dungeons with staircases do exist, but you can't build your own dungeon with staircases. Not at the moment, but that is expected to change in Alpha 27 when it is released.
...
*A: Use the [[File:ReportBugButton.png|link=]] in the bottom right of the screen.
