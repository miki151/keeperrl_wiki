---
title: Old Official Game Configs
permalink: Old_Official_Game_Configs/
layout: wiki
---
...
https://github.com/miki151/keeperrl/blob/master/data_free/game_config/build_menu.txt

=Building_Info.txt=
*Defines the tiles that buildings are made of.

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/building_info.txt

=Campaign_Villains.txt=
*Defines which tribes appear on campaign maps.

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/campaign_villains.txt

=Creature_Inventory.txt=
*Defines the items used and dropped by enemies.
https://github.com/miki151/keeperrl/blob/master/data_free/game_config/creature_inventory.txt

=Creatures.txt=
*Defines the creatures that exist.
https://github.com/miki151/keeperrl/blob/master/data_free/game_config/creatures.txt

=Details.txt=
*Defines mod details

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/details.txt

=Endless_Enemies.txt=
*Defines the invaders that can attack during endless waves.

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/endless_enemies.txt

=Enemies.txt=
*Defines the tribes that can exist.

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/enemies.txt

=Furniture.txt=
*Defines the types of furniture that can exist.

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/furniture.txt

=Furniture_Lists.txt=
*Defines the furniture used by different tribes.

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/furniture_lists.txt

=Immigration.txt=
*Defines which immigrants can be recruited and how.

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/immigration.txt

=Intro_Text.txt=
*Defines the text that is displayed when the game starts.

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/intro_text.txt

=Item_Lists.txt=
*Defines the items that can be discovered when looting and exploring.

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/item_lists.txt

=Items.txt=
*Defines what items exist

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/items.txt

=Names.txt=
*Defines which randomly generated names could be used.

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/names.txt

=Player_Creatures.txt=
*Defines which keeper classes and which adventurer classes exist.

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/player_creatures.txt

=Resources.txt=
*Defines what resources are available to mine.

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/resources.txt

=Spell_Schools.txt=
*Defines what spell schools exist and which spells they contain.

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/spell_schools.txt

=Spells.txt=
*Defines the spells that exist

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/spells.txt

=Technology.txt=
*Defines what technologies exist.

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/technology.txt

=Tiles.txt=
*Defines how the tiles look in ascii mode

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/tiles.txt

=Workshops_Menu.txt=
*Defines which items can be built in labs, workshops, jewellers and forges

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/workshops_menu.txt

=ZLevels.txt=
*Defines what sort of zlevels are generated.

https://github.com/miki151/keeperrl/blob/master/data_free/game_config/zlevels.txt
