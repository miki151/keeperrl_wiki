---
title: Old Requests For New Traits
permalink: Old_Requests_For_New_Traits/
layout: wiki
---
Existing traits are:

 Animal, Blind, Brainless, Carry Anything, Courage, Explore, Humanoid,
 Fire Creature, Flying, Not Breathing, Innocent, Stationary, Uncorporal, Undead

Existing lasting effects are:

 Invisible, Panic, Enraged, Hallucinating, Damage bonus, Defense bonus, Sleep resistant
 Speed bonus, Poison resistant, Fire resistant, Flying, Source of light, Source of darkness,
 Pregnant, Resistant to magical attacks, Resistant to melee attacks,
 Resistant to ranged attacks, Can see through trees, Can see in the dark,
 Regenerating, Aware of danger,Telepathic, Satiated, Rested, Peaceful,
 Poisoned, Bleeding, Sleeping, Entangled, Tied up, Slowed, Insane, Unconscious, Collapsed,
 Vulnerable to magical attacks, Vulnerable to melee attacks,
 Vulnerable to ranged attacks, Vulnerable to sunlight, Time Left to live
...
== Rogue-like (Implemented through specifying the possible xp gain for a minion. eg. Alpha 25)==
...
== No levelling (Implemented in alpha 26 where no xp gain is available on a minion)==
