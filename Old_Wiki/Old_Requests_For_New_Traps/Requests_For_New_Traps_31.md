---
title: Requests For New Traps 31
permalink: Requests_For_New_Traps_31/
layout: wiki
---
...
==Magic bolt trap (Or guardian statue)==
* Build cost: 120 mana
* Damage: Medium
* Effects: Physical damage
* Concept: A statue that shoots arrows. 
...
== Trick bed / bookshelf / chest ==
* Build Cost: 100 mana
* Damage: Physical damage
* Special effects: Animated Objects (trap that causes beds or bookshelves, or mimic chests to attack intruders)
* Concept: Some traps can be visible and look like other common dungeon objects
* Purpose in game: Bookshelves that fight back! Perhaps more difficult to disarm. 
* Optional features: 
* Discussion: Discuss the idea here.
...
* Concept: Door based traps (May need a change to game mechanics)
