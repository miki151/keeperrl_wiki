---
title: Old Requests For New Spells
permalink: Old_Requests_For_New_Spells/
layout: wiki
---
...
* Makes the target immune to all damage sources for 5 ticks
* range 1
* 40 tick cooldown
...
* Heals a target to full health
* Cooldown 10 ticks
* Range 3

== Overheal ==

* Heals a target for 1.5x their full health (adds a damage shield of 0.5 the target's Health)
* Cooldown 20 ticks
* Range 2

== Drain Life ==

* Heals the caster for the amount of damage done to the target
* damage increases based on Life School spell Mastery
* base damage is 25% of the caster's health max
* Range 5

== Vaccine ==

* cures Poison
* gives immunity to poison for 20 ticks
* cooldown 25
* range 3
...
* cures bleeding
* gives immunity to bleeding for 20 ticks
* gives 50% resistance to vampirism for 20 ticks
* cooldown 25
* range 3
...
* grants immunity to all status effects, good or bad, for 10 ticks
* cooldown 35
* Range 3

== Revive ==

* Revives a single unit from death to full health
* cooldown 150
* Range 3

== Protection ==

* Reduces incoming damage from all sources by 75% for targeted unit
* gives immunity to status effects for 20 ticks
* lasts for 20 ticks

== Area heal ==

* Heals all units to full health in a targeted 3x3 area
* Cooldown 30 ticks
* Range 5

== Life Aura ==

* Give all friendly units within 5 tiles of the caster a regenerate health effect
* effects last 50 ticks
* Cooldown 80 ticks

== Life's Call ==

* Revives a group of friendly units in a 3x3 area
* allies revive at half health
* range 5
* Cooldown 300 ticks

== Miracle of Sacrifice ==

* Caster sacrifices his life essence in order to overheal all his allies in his Line of SIght by 3x their max HP
* takes 3 ticks to cast
* kills caster
* can only be used 10 times per game
