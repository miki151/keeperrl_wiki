---
title: Old Map Editor Ideas
permalink: Old_Map_Editor_Ideas/
layout: wiki
---
...
There is a possibility that a later version of Keeper will include a map editor. Please provide your ideas here.
...
*Create custom zlevel caves that can be included in a mod or added to the base game.

*Two different versions of the editor should be made, one version will be designed towards balance and replayability and the other will be a complete dungeon creation tool with no limiters.

*Entry points of zlevels will start in the middle of the map and will be fixed like in randomly generated zlevels.

*Custom levels in the balanced version of the editor will be randomly generated in-game based on their designated depth. Trap availability and max enemy power levels will depend on how deep the level is and included resource clusters may increase/decrease the enemy severity, but only up to a certain point. (Basically, you will have a set amount of power and defense to add enemies to the balanced version as well as a limited number of traps. Traps should have their own power levels that can be adjusted based on player feedback.)

*This mode should probably be an offshoot of the complete terrain editor.

*A way to differentiate zlevel generation for the keeper's dungeon or random tribe areas should be included
